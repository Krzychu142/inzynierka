...
router.put('/uploadImageToProduct/:id', AuthMiddleware.checkIsEmployeeLoggedIn, AuthMiddleware.checkIsEmployeeHaveCorrectPermission([Role.WAREHOUSEMAN, Role.MANAGER, Role.SALESMAN]),
upload.single('image'),
ProductController.uploadImageToProduct)

router.delete('/deleteImageByURL',AuthMiddleware.checkIsEmployeeLoggedIn, AuthMiddleware.checkIsEmployeeHaveCorrectPermission([Role.WAREHOUSEMAN, Role.MANAGER, Role.SALESMAN]),  ProductController.deleteImageByURL)
